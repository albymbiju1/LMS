...
<body>
    ...
    <div class="wrapper">
        <div class="unenroll-header">
            <h2><i class="fas fa-user-minus"></i> Unenroll from Course</h2>
            <p class="mb-0">Are you sure you want to unenroll from this course?</p>
        </div>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?course_id=" . $course_id); ?>" method="post">
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-user-minus"></i> Confirm Unenrollment
                    </button>
